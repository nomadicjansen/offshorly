...
return [
    ...
    'timestamp' => 1499140331,
    'checksum' => '6c5ae77e309841bc0631263f9cf807a9',
    'files' => [
        'user/config' => [
            'media' => [
    ...
    'data' => [
        'plugins' => [
            ...
            'feed' => [
                'enabled' => true,
                'limit' => 99,
                'description' => 'Offshorly Newsfeed',
                'lang' => 'en-us',
                'length' => 500,
            ...
            'recaptchacontact' => [
                ...
                'grecaptcha_sitekey' => '6LfL3RYUAAAAAFVPbP__WBVsFIUo7XYgUAtPnAjL',
                'grecaptcha_secret' => '6LfL3RYUAAAAACsu11o23lSmsamrx-82hWfmKU3q',
            ...
            'cdn' => [
                'enabled' => false,
                'inline_css_replace' => false,
                'pullzone' => 'https://code.jquery.com/jquery-2.2.4.min.js',
                'tags' => 'script',
                'tag_attributes' => 'src',
                'extensions' => 'js',
                'valid_formats' => 'html'
        ...
        'site' => [
            ...
            'metadata' => [
                'description' => 'offshore web outsource',
                'keywords' => 'offshorly, offshore, web, outsource',
                'generator' => 'GravCMS',
                'robots' => 'index, follow',
                'theme-color' => '#009275',
                'google-site-verification' => 'xcwuZNo5pIJg3acdhtxhyFCMaETtpSFQ1Uoeuo-LCTI'
            ],
            'summary' => [
                'enabled' => true,
                'format' => 'short',
