...
/* feed.rss.twig */
class __TwigTemplate_3160b3a199e3d7a71a7c2f81cc3ed47371c0157d4385307139a59438fed06271 extends Twig_Template
{
...
<rss xmlns:atom=\"http://www.w3.org/2005/Atom\" version=\"2.0\">
    <channel>
        ...
        echo ".";
        echo twig_escape_filter($this->env, $this->getAttribute(($context["uri"] ?? null), "extension", array(), "method"), "html", null, true);
        echo "</link>
        <description>";
        // line 7
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["collection"] ?? null), "params", array()), "description", array()), "html", null, true);
        echo "</description>
        <language>";
        // line 8
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["collection"] ?? null), "params", array()), "lang", array()), "html", null, true);
        echo "</language>
        <atom:link href=\"";
        // line 9
        echo twig_escape_filter($this->env, $this->getAttribute(($context["uri"] ?? null), "url", array(0 => true), "method"), "html", null, true);
        echo ".";
        echo twig_escape_filter($this->env, $this->getAttribute(($context["uri"] ?? null), "extension", array()), "html", null, true);
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            ...
            <link>";
            // line 14
            echo twig_escape_filter($this->env, $this->getAttribute($context["item"], "url", array(0 => true), "method"), "html", null, true);
            echo "</link>
            <description>
                <![CDATA[
                ";
            ...
            // line 20
            echo "                ";
            echo $this->env->getExtension('Gantry\Component\Twig\TwigExtension')->truncateHtml($this->getAttribute($context["item"], "content", array()), $this->getAttribute($this->getAttribute(($context["collection"] ?? null), "params", array()), "length", array()));
            echo "
                ]]>
            </description>
            <category>";
            // line 23
            echo twig_escape_filter($this->env, twig_join_filter($this->getAttribute($this->getAttribute($context["item"], "taxonomy", array()), "tag", array()), ","), "html", null, true);
            echo "</category>
            <guid>";
            // line 24
            echo twig_escape_filter($this->env, $this->getAttribute($context["item"], "url", array(0 => true), "method"), "html", null, true);
            ...
            <pubDate>";
            // line 25
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($context["item"], "date", array()), "D, d M Y H:i:s O"), "html", null, true);
            echo "</pubDate>
        </item>
        ";
        }
...
", "feed.rss.twig", "C:\\projects\\xampp\\htdocs\\offshorly\\user\\plugins\\feed\\templates\\feed.rss.twig");
    }
}
